...
| skill | `review-change` | Review diffs for defects and test gaps. |
| skill | `safe-migration` | Stage compatible migrations with rollback. |
| skill | `security-review` | Review scoped security boundaries and risks. |
| skill | `systematic-debugging` | Investigate root causes before fixing. |
...
| subagent | `security-reviewer` | Trace security boundaries and exploit paths. |
| subagent | `verifier` | Run and report declared verification commands. |
